    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-yellow">
          <div class="inner">
            <?php 
            $user = mysqli_query($myConn,"SELECT * FROM user");
            ?>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-red">
          <div class="inner">
            <?php 
            $suplier = mysqli_query($myConn,"SELECT * FROM suplier");
            ?>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-aqua">
          <div class="inner">
            <?php 
            $pinjam = mysqli_query($myConn,"SELECT * FROM pinjam");
            ?>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-primary">
          <div class="inner">
            <?php 
            $barang_masuk = mysqli_query($myConn,"SELECT sum(bm_jumlah) as total_barang_masuk FROM barang_masuk");
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-purple">
          <div class="inner">
            <?php 
            $barang_keluar = mysqli_query($myConn,"SELECT sum(bk_jumlah_keluar) as total_barang_keluar FROM barang_keluar");
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-orange">
          <div class="inner">
            <?php 
            $barang_masuk = mysqli_query($myConn,"SELECT * FROM barang_masuk");
            ?>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-blue">
          <div class="inner">
            <?php 
            $barang_keluar = mysqli_query($myConn,"SELECT * FROM barang_keluar");
            ?>
       ...
       <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-green">
          <div class="inner">
            <?php 
            $peminjaman = mysqli_query($myConn,"SELECT * FROM pinjam WHERE pinjam_status='dikembalikan'");
            ?>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-red">
          <div class="inner">
            <?php 
            $peminjaman = mysqli_query($myConn,"SELECT * FROM pinjam WHERE pinjam_status='dipinjam'");
            ?>
            <h3><?php echo mysqli_num_rows($peminjaman); ?></h3>
