    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-yellow">
          <div class="inner">
            <?php 
            $user = $myConn->query("SELECT * FROM user");
            ?>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-red">
          <div class="inner">
            <?php 
            $suplier = $myConn->query("SELECT * FROM suplier");
            ?>
            <h3><?php echo $suplier->num_rows; ?></h3>
            <p>Suplier</p>
          </div>
          <div class="icon">
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-aqua">
          <div class="inner">
            <?php 
            $pinjam = $myConn->query("SELECT * FROM pinjam");
            ?>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-primary">
          <div class="inner">
            <?php 
            $barang_masuk = $myConn->query("SELECT sum(bm_jumlah) as total_barang_masuk FROM barang_masuk");
            $bm = $barang_masuk->fetch_assoc();
            ?>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-purple">
          <div class="inner">
            <?php 
            $barang_keluar = $myConn->query("SELECT sum(bk_jumlah_keluar) as total_barang_keluar FROM barang_keluar");
            $bk = $barang_keluar->fetch_assoc();
            ?>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-orange">
          <div class="inner">
            <?php 
            $barang_masuk = $myConn->query("SELECT * FROM barang_masuk");
            ?>
            <h3><?php echo $barang_masuk->num_rows; ?></h3>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-blue">
          <div class="inner">
            <?php 
            $barang_keluar = $myConn->query("SELECT * FROM barang_keluar");
            ?>
            <h3><?php echo $barang_keluar->num_rows; ?></h3>
       ...
       <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-green">
          <div class="inner">
            <?php 
            $peminjaman = $myConn->query("SELECT * FROM pinjam WHERE pinjam_status='dikembalikan'");
            ?>
            <h3><?php echo $peminjaman->num_rows; ?></h3>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-red">
          <div class="inner">
            <?php 
            $peminjaman = $myConn->query("SELECT * FROM pinjam WHERE pinjam_status='dipinjam'");
            ?>
            <h3><?php echo $peminjaman->num_rows; ?></h3>
